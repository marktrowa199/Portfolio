...
const CONNECTIONS: Connection[] = [
  ...
  },
  {
    ...
    x: 354,
    y: 70,
    path: "M220,160 L354,160 L354,70",
    travelMs: 1200,
    pauseMs: 2200,
    phaseMs: 600,
  },
  ...
  },
  {
    ...
    x: 354,
    y: 250,
    path: "M220,160 L354,160 L354,250",
    travelMs: 1150,
    pauseMs: 2500,
    phaseMs: 1800,
  },
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-slate-700 dark:text-slate-light light:text-slate-800">
        ...
        >
          ...
          {CONNECTIONS.map((conn) => (
            <path
              ...
              className={`
                ...
                ${
                  hovered === conn.id
                    ? "stroke-[var(--accent-cyan)] dark:stroke-[var(--accent-cyan)]"
                    : "stroke-slate-300 dark:stroke-[var(--border-card)]"
                }
              `}
            />
          ))}
          ...
          {CONNECTIONS.map((conn) => (
            <circle
              ...
              r={2.6}
              className="fill-[var(--accent-blue)] dark:fill-[var(--accent-blue)]"
          ...
          <circle
            ...
            strokeWidth={1}
            strokeOpacity={0.18}
            className="fill-none stroke-teal-600 dark:stroke-[var(--accent-cyan)]"
          >
            {!reducedMotion && (
              <animate
                attributeName="r"
